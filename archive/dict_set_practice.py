...
# # Use a set!
# unique_visitors = set(daily_scans)  # Add your code
...
# first_time_visitors = set(today_scans) - known_users
...
#     # for loop
#     # counts - entries, exits, entry by gate
#     # currenly inside - add/discard on 'entry' / 'exit'
#     # if currently_inside > peak_occupancy: peak_occupancy = currently inside

#     for event_scan in events:
#         user_id = event_scan['user_id']
#         gate = event_scan['gate']
#         action = event_scan['action']
...
#         if action == 'entry' and user_id not in currently_inside:
#             currently_inside.add(user_id)
#         elif action == 'entry' and user_id in currently_inside:
#             double_entry.add(user_id)
#         elif action == 'exit' and user_id not in currently_inside:
